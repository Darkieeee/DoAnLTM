                ...
                str.append("<html>")
                        .append("<body>")
                            .append("<div style='margin-bottom: 2px'>")
                                .append("<span style='color: Teal; font-weight:bold; font-size:11.5pt; font-family: Arial'>").append(((ChiTietMonHoc) value).getMaMonHoc()).append("</span>")
                            .append("</div>")
                            .append("<div>")
                                .append("<span style='color: gray; font-style: italic; font-size:11.5pt; font-weight:bold; font-family: Arial'>").append("Phòng học: ").append("</span>")
                                .append("<span style='color: Teal; font-weight:bold; font-size:11.5pt; font-family: Arial'>").append(((ChiTietMonHoc) value).getSoPhong()).append("</span>")
                            .append("</div>")
                        .append("</body>")
                   .append("</html>")
                ;
